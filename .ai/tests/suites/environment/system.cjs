...
const { runCommand } = require('../../lib/exec.cjs');
const { pickPython } = require('../../lib/python.cjs');
const { assertIncludes, assertNotIncludes } = require('../../lib/text.cjs');

const name = 'environment-system';
