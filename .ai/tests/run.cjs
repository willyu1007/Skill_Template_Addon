...
const { createEvidenceDir, createLogger, generateRunId, rmEvidenceDir, writeRunJson } = require('./lib/evidence.cjs');

const uiSuite = require('./suites/ui/index.cjs');
const envSuite = require('./suites/environment/index.cjs');
const dbSuite = require('./suites/database/index.cjs');
...
function usage(exitCode) {
  const msg = [
    'Usage:',
    '  node .ai/tests/run.cjs --list',
    '  node .ai/tests/run.cjs --suite <ui|environment|database>',
    '',
    'Options:',
