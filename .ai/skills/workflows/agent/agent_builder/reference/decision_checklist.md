...
Record in: `stageA/integration-decision.md`, `stageB/agent-blueprint.json` (`integration.*`, `interfaces[]`).
...
Record in: `stageA/integration-decision.md`, `stageB/agent-blueprint.json` (`api.*`).
...
Record in: `stageB/agent-blueprint.json` (`schemas.*`, schema refs).
...
Record in: `stageA/interview-notes.md`, `stageB/agent-blueprint.json` (`data_flow.*`, `operations.*`, or a new `conversation` block).
...
Record in: `stageA/interview-notes.md`, `stageB/agent-blueprint.json` (`interfaces[]` notes or a new `output` block).
...
Record in: `stageA/interview-notes.md`, `stageB/agent-blueprint.json` (`tools.tools[]`, `security.*`).
...
Record in: `stageA/interview-notes.md`, `stageB/agent-blueprint.json` (`model.*`, `prompting.*`).
...
Record in: `stageA/integration-decision.md`, `stageB/agent-blueprint.json` (`integration.*`, `worker.*`, `configuration.env_vars`).
...
Record in: `stageA/interview-notes.md`, `stageB/agent-blueprint.json` (`api.timeout_budget_ms`, `model.*`, `operations.*`).
...
Record in: `stageA/interview-notes.md`, `stageB/agent-blueprint.json` (`data_flow.*`, `security.*`).
...
Record in: `stageA/interview-notes.md`, `stageB/agent-blueprint.json` (`observability.*`, `operations.*`).
