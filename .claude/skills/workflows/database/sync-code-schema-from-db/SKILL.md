...
ssot_path: .ai/skills/workflows/database/sync-code-schema-from-db
---

# sync-code-schema-from-db (entry)

Canonical source: `.ai/skills/workflows/database/sync-code-schema-from-db/`

Open `.ai/skills/workflows/database/sync-code-schema-from-db/SKILL.md` and any supporting files referenced there (for example `reference.md`, `examples.md`, `scripts/`, `templates/`).
