...
category: features/observability
ssot_path: .ai/skills/features/observability/feature-observability
---

# feature-observability (entry)

Canonical source: `.ai/skills/features/observability/feature-observability/`

Open `.ai/skills/features/observability/feature-observability/SKILL.md` and any supporting files referenced there (for example `reference.md`, `examples.md`, `scripts/`, `templates/`).
