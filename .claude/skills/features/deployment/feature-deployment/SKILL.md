...
ssot_path: .ai/skills/features/deployment/feature-deployment
---

# feature-deployment (entry)

Canonical source: `.ai/skills/features/deployment/feature-deployment/`

Open `.ai/skills/features/deployment/feature-deployment/SKILL.md` and any supporting files referenced there (for example `reference.md`, `examples.md`, `scripts/`, `templates/`).
