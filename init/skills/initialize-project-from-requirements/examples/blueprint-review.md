...
> **Note**: The blueprint is stored in `init/project-blueprint.json` during initialization. After completion, use `cleanup-init --archive` to archive it to `docs/project/overview/`.
